        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <FiUser className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 text-base" />
              <input
                id="name"
                name="name"
                type="text"
          ...
          <div>
            ...
            <div className="relative">
              <FiBriefcase className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 text-base z-10" />
              <select
                id="role"
                name="role"
                value={role}
